# This script is used to plot the respiratory signal and the heart rate variability from the ECG and BVP signals
...
def pca():
    """
    This function is used to plot the PCA and Autoencoder results
    """
...
def plot_result():
    ...
    acc = [[93.88, 93.02], [83.12, 76.36], [68.42, 53.85], [75.76, 57.89], [85.71, 88.89], [70.68, 29.09],
           [94.29, 93.94], [90.91, 90.0], [67.83, 17.78], [68.75, 80.77], [86.96, 89.66], [100.0, 100.0],
           [98.46, 98.51], [94.92, 94.74], [97.87, 97.96], [85.25, 80.85], [67.77, 29.09], [77.55, 74.42],
           [74.67, 48.65], [93.62, 92.68], [82.76, 73.68], [97.78, 97.87], [100.0, 100.0], [95.24, 95.65],
           [66.67, 45.71], [94.92, 95.38], [94.25, 93.51], [88.52, 86.27], [80.0, 85.71], [89.8, 87.18],
           [75.41, 51.61], [87.8, 87.8], [100.0, 100.0], [96.97, 97.14], [96.97, 97.14], [83.33, 87.5], 
           [94.74, 95.24], [94.34, 94.92], [89.47, 87.76], [86.32, 81.16], [91.67, 91.18], [81.63, 70.97], 
           [72.73, 51.61], [74.07, 46.15], [100.0, 100.0]
]
